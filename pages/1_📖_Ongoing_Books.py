...
def main(df,selected_option):
    ...
    if selected_option == "Show Data":
        ...
        if percent_chapter_or_page=='Chapterwise':
            ...
            sns.barplot(x='title', y='total_chapters',color='#262730',edgecolor="1",data=chapterwise, width=0.4)
            sns.barplot(x='title', y='current_chapter',color='#c42b2b',capsize=.3,edgecolor="1",data=chapterwise, width=0.4)
