...
def main():
    if 'running_books_df' not in st.session_state:
        st.session_state.running_books_df = df[df['status']=='Ongoing']
        
    running_books_df=running_books(st.session_state.running_books_df)
